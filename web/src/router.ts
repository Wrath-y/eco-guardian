...
import AIDesignView from './features/ai-design/AIDesignView.vue'
import RuntimeSettingsView from './views/RuntimeSettingsView.vue'
import ImpactView from './features/impact/ImpactView.vue'
import BackupsView from './views/BackupsView.vue'

const router = createRouter({ history: createWebHistory(), routes: [{ path: '/', redirect: '/projects' }, { path: '/projects', component: ProjectsView }, { path: '/settings', component: RuntimeSettingsView }, { path: '/backups', component: BackupsView, meta: { project: true } }, { path: '/config/:kind', component: EntityListView, meta: { project: true } }, { path: '/config/:kind/:id', component: EntityEditorView, meta: { project: true } }, { path: '/versions', component: VersionsView, meta: { project: true } }, { path: '/versions/:id/diff', component: RevisionDiffView, meta: { project: true } }, { path: '/simulations', component: SimulationsView, meta: { project: true } }, { path: '/impact', component: ImpactView, meta: { project: true } }, { path: '/risk-reviews', component: RiskReviewsView, meta: { project: true } }, { path: '/ai-design', component: AIDesignView, meta: { project: true } }] })
