...
func TestDefinitionRejectsUnknownParticipantsAndInvalidBudgets(t *testing.T) {
	definition := Definition{ID: "single-target", Version: "v1", Participants: []Participant{{ID: "source", Kind: "actor"}}, Actions: []Action{{ID: "strike", EventID: "damage", SourceID: "source", TargetID: "target"}}, DurationMS: 30_000, Budgets: Budgets{MaxEvents: 1, MaxSteps: 1, MaxSamples: 1, MaxRuntimeMS: 1}}
