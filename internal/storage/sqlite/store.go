...
func applyMigrationSteps(ctx context.Context, tx *sql.Tx, version int, hook func(string) error) error {
	...
	if version == 19 {
		if err := applyMigrationV20(ctx, tx); err != nil {
			return err
		}
		if hook != nil {
			if err := hook("ai-preview-facts-v20"); err != nil {
				return err
			}
		}
		version = 20
	...
	if version == 20 {
		if err := applyMigrationV21(ctx, tx); err != nil {
			return err
		}
		if hook != nil {
			if err := hook("dependency-impact-v21"); err != nil {
				return err
			}
		}
		version = 21
...
func applyMigrationV20(ctx context.Context, tx *sql.Tx) error {
	body, err := root.Assets.ReadFile("migrations/0020_ai_preview_facts.sql")
	if err != nil {
		return err
	}
	if _, err = tx.ExecContext(ctx, string(body)); err != nil {
...
func applyMigrationV21(ctx context.Context, tx *sql.Tx) error {
	body, err := root.Assets.ReadFile("migrations/0021_dependency_impact.sql")
	if err != nil {
		return err
	}
	if _, err = tx.ExecContext(ctx, string(body)); err != nil {
